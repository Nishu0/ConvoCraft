...
def message_func(text, is_user=False):
    ...
    if is_user:
        ...
        avatar_url = "https://avataaars.io/?avatarStyle=Transparent&topType=ShortHairShortRound&accessoriesType=Prescription02&hairColor=Black&facialHairType=BeardLight&facialHairColor=Black&clotheType=BlazerShirt&eyeType=Happy&eyebrowType=UpDownNatural&mouthType=Smile&skinColor=Pale"
...
def reset_chat_history():
    ...
    st.session_state["messages"] = [
        ("Hello! I'm a chatbot designed to help you with Streamlit App Coding by Nisarg Thakkar")
    ]