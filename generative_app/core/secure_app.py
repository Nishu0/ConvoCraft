...
from app_pages.ConvoCraft import ChatBotApp
...
st.set_page_config(
    ...
    menu_items={
        "Report a bug": "https://github.com/Gamma-Software/ConvoCraft/issues",
        "About": f"""
            # ConvoCraft - {VERSION}
            ...
            Go to the GitHub repo to learn more about the project. https://github.com/Gamma-Software/ConvoCraft
            """,  # noqa: E501
    },
)
...
if __name__ == "__main__":
    ...
    if user_access_level == 1:
        ...
        app.add_app(
            "ConvoCraft",
            icon="💬",
            app=ChatBotApp(title="ConvoCraft", generative_app_path=path_to_script),
        )

        # add all your application classes here
        app.add_app(title, icon="💫", app=app_to_add)
        complex_nav = {
            "ConvoCraft": ["ConvoCraft"],
        }
